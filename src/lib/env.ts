...
export const DOCS_HOME_URL = 'https://github.com/Justin-Developer01/stream-watcher/blob/main/docs/index.md'
export const DOCS_USAGE_URL = 'https://github.com/Justin-Developer01/stream-watcher/blob/main/docs/USAGE.md'
export const DOCS_FEATURES_URL = 'https://github.com/Justin-Developer01/stream-watcher/blob/main/docs/FEATURES.md'
